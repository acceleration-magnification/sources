...
function res = reconSFpyr_scale(pyr, pind, levs, bands, twidth, scale)
...
if (size(pind,1) == 2)
  ...
  resdft = reconSFpyrLevs_scale(pyr(1+prod(pind(1,:)):size(pyr,1)), ...
      pind(2:size(pind,1),:), ...
      log_rad, Xrcos, Yrcos, angle, nbands, levs, bands, scale);
end
